...
const clientEntrypoints = [
  {
    name: 'CLIENT - Send/Draft emails',
    entry: './src/client/dialog-send-emails/index.js',
    filename: 'dialog-send-emails', // we'll add the .html suffix to these
    template: './src/client/dialog-send-emails/index.html',
  }
];
